...
4. Using the context manager for automatic flush on exit
...
def main() -> None:
    with tempfile.TemporaryDirectory() as tmpdir:
        config = AuditLoggerConfig(
            ...
            # v1.1: Lambda-safe defaults (flush every 300s or 500 events)
        ...
        # Context manager calls close() on exit, which flushes telemetry
        ...
        # logger.close() was called automatically by the context manager
